...
export interface PartnerApplicationRepository {
    ...
    findAll(options?: { offset?: number; limit?: number; filters?: { status?: string; name?: string; user_email?: string; } }): Promise<{ applications: PartnerWithRelationsRow[]; count: number }>;
